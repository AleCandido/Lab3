...
\begin{figure}[h!]
	\centering
		\includegraphics[width=0.9\textwidth]{../grafici/fast_plot_f_domain.pdf}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=0.6\textwidth]{../grafici/fit_low_frequency.pdf}
		\caption{Fit basse frequenze}
\end{figure}
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{../grafici/fit_high_frequency.pdf}
...
\begin{figure}[h!]
	\centering
		\includegraphics[width=0.7\textwidth]{../grafici/fit_C_E.pdf}
		\caption{Risposta in frequenza}
\end{figure}
...
\begin{figure}[h]
	...
	\captionof{table}{Dati risposta in tensione}
	\label{tensione}
		\end{minipage}
	\begin{minipage}[c]{0.4\textwidth}
		\centering
