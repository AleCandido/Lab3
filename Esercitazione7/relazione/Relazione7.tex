...
Riguardo $V_+$ si ha che questo è determinato da $V_{out}$ e dal rapporto di partizione $R_1 - R_2$, che in questo caso, poiché $R_1 \sim R_2$ è circa la metà. Per l'esattezza il rapporto di partizione atteso è pari a $\unit{}$ mentre il rapporto fra le due tensioni misurate è pari a $\unit{}$, e quindi i due valori sono compatibili.
