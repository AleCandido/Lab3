...
\marginpar{errori da ricalcolare}
\begin{table}[h!]
\centering
\begin{tabular}{c|c|c}
 & $I_B$ [$\mu$A]& $I_C$ [mA]\\
...
\marginpar{Vorrei citare Child's Law per effetti di carica spaziale, ma non ho avuto sbatta di verificare se siamo nelle ipotesi giuste, inoltre rimane sempre il problema del delay in salita}
