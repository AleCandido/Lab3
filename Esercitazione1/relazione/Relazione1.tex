...
% Se avessi una stima statistica della parent distribution (media e deviazione standard sotto l'ipotesi di gaussianità) allora, fregandomene dell'errore sulla 'seconda' misura potrei verificare a quanti \sigma sta dalla media.
% Avendo due misure con errore o due stime statistiche diverse non ho la più pallida idea di come confrontarle e su che base dire che sono compatibili
