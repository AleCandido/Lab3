...
\section{Trigger dell'oscilloscopio}\documentclass[10pt,a4paper]{article}
...
\begin{document}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[b]{.35\textwidth}
			...
			\captionof{table}{Didascalia della tabella}\label{...}
		\end{minipage}\hspace*{\fill}
		>>>>>>> 605f5089119a46f916a1b09dd53fa4b46bb9110e
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[b]{.6\textwidth}
			...
			\begin{minipage}[h]{0.35\textwidth}
				\centering
				\input{../tabelle/tab_4MOhm.txt}
				\captionof{table}{Partitore di tensione, resistenza $\sim 4M\Omega$}
			\end{minipage}%
			\begin{minipage}[h]{0.65\textwidth}
				\centering
